...
public class PinkGhost extends Ghost {
	...
	private Image aniUp01 = new Image("/PinkGhost01.png");
	private Image aniUp02 = new Image("/PinkGhost02.png");
	private Image aniRight01 = new Image("/PinkGhostRight01.png");
	private Image aniRight02 = new Image("/PinkGhostRight02.png");
	private Image aniDown01 = new Image("/PinkGhostDown01.png");
	private Image aniDown02 = new Image("/PinkGhostDown02.png");
	private Image aniLeft01 = new Image("/PinkGhostLeft01.png");
	private Image aniLeft02 = new Image("/PinkGhostLeft02.png");
	
	private Image[][] animations = {{aniUp01, aniRight01, aniDown01, aniLeft01},
										{aniUp02, aniRight02, aniDown02, aniLeft02}
									};
	
	public PinkGhost(MainGame game) {
		this.game = game;
	...
	public void updateDestination() {
		...
		case hunt:
			this.setDestination(game.pacMan.getPosition().getNeighbor(this.game.pacMan.getDir()).getNeighbor(this.game.pacMan.getDir()).
					getNeighbor(this.game.pacMan.getDir()).getNeighbor(this.game.pacMan.getDir()));
			break;
		case scater:
